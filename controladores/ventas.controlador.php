...
class ControladorVentas{
    ...
    static public function ctrCrearVenta(){
        ...
        //ACTUALIZAR LAS COMPRAS DEL CLIENTE Y REDUCIR EL STOCK
            ...
            $traerClientes= ModeloClientes::mdlMostrarClientes($tablaClientes,$item,$valor);

            $item1a = "compras";
            $valor1a= array_sum($totalProductosComprados) + $traerClientes["compras"];
    ...
    static public function ctrEditarVenta(){
        ...
        //FORMATEAR LA TABLA DE PRODUCTOS Y LA DE CLIENTES
            ...
            if($cambioProducto==true){
                ...
                $traerClientes= ModeloClientes::mdlMostrarClientes($tablaClientes,$itemCliente,$valorCliente);

                $item1a = "compras";
                $valor1a= $traerClientes["compras"] - array_sum($totalProductosComprados);
            ...
            //ACTUALIZAR LAS COMPRAS DEL CLIENTE Y REDUCIR EL STOCK
                ...
                foreach ($listaProductos_2 as $key => $value) {
                    ...
                    $nuevasVentas_2= ModeloProductos::mdlActualizarProducto($tablaProductos_2,$item1a_2, $valor1a,$valor_2);
                ...
                $traerClientes_2= ModeloClientes::mdlMostrarClientes($tablaClientes_2,$item_2,$valor_2);

                $item1a_2 = "compras";
                $valor1a_2= array_sum($totalProductosComprados_2) + $traerClientes_2["compras"];
                
                $comprasCliente_2 = ModeloClientes::mdlActualizarClientes($tablaClientes_2,$item1a_2, $valor1a_2, $valor_2);
                ...
                $comprasCliente_2 = ModeloClientes::mdlActualizarClientes($tablaClientes_2,$item1b_2, $valor1b_2, $valor_2);
