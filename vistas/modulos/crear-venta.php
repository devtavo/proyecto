                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style="width: 50%">
                              <div class="input-group">
                                <input type="number"min="0" name="nuevoImpuestoVenta" id="nuevoImpuestoVenta"  class="form-control" placeholder="0" required>
                            ...
                            <td style="width: 50%">
                              <div class="input-group">
                                ...
                                <input type="text" name="nuevoTotalVenta" total="" id="nuevoTotalVenta" class="form-control" placeholder="00000" readonly required>
